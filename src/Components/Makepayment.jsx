...
const Makepayment = () => {
    ...
    const handlesubmit = async (e) =>{
        ...
        try{
            ...
            const response = await axios.post("https://sethstanley.alwaysdata.net/api/mpesa_payment", formdata)
  ...
  return (
    ...
    <div className='row justify-content-center'>
        ...
        <div className="col-md-6 card shadow p-4">
            ...
            <img src={img_url + product.product_photo} alt="Product name" className='image'/>
            ...
            <div className="card-body ">
                ...
                <h3 className="text-warning">Kes {product.product_cost}/Hour </h3> <br />

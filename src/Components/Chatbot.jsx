...
const rules = [
  ...
  { keys: /career|job|profession|path|growth/i,
    reply: "🚀 A great mentor can fast-track your career! Explore our <a href='/mentors'>mentor directory</a> to find professionals in your desired field who can guide your journey." },
